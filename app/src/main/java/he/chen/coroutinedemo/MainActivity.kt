...
import he.chen.coroutinedemo.databinding.ActivityMainBinding
import he.chen.coroutinedemo.java.CoroutineEntry
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_main).apply {
